...
import os
import json
from blloesign.tasks.commons.GetDynamicTemplate import uploadOneFile, uploadAndConvert2Html
from blloesign.tasks.commons.CopyTemplate import copy
from blloesign.esign.Client import eqb_sign
from blloesign.esign.esign_enums.file_status import FileStatus
...
from blloesign.esign.eqb_functions import (
    template_function, 
    set_title, 
    post_handler
    )
...
class AutoLoadCommandSet(CommandSet, Observable):
    ...
    def do_company(self, args):
        ...
        if len(orgInfo) > 0:
            ...
            from blloesign.esign.esign_enums.org_type import OrgTypeEnum
